...
app.post('/registration', async (req, res) => {
    ...
    try {
        ...
        const [existingUsers] = await connection.execute('SELECT * FROM QuizText WHERE email = ?', [email]);
        ...
        const [result] = await connection.execute('INSERT INTO QuizText (name, email, password) VALUES (?, ?, ?)', [name, email, password]);
        connection.release();
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        const [rows] = await connection.execute('SELECT * FROM QuizText WHERE email = ?', [email]);
...
/*app.get('/ghfsc.jpg', (req, res) => {
    res.sendFile(__dirname + '/ghfsc.jpg');
});*/
